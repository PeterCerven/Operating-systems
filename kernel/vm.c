...
uvmcopy(pagetable_t old, pagetable_t new, uint64 sz)
{
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    inc_ref((void *)pa);
    // navysit referencie fyzickej stranky
  }
  return 0;
...
uvmcow(pagetable_t pagetable, uint64 addr)
{
  ...
  memmove(mem, (char*)pa, PGSIZE);
  // ked je posledna uvolnit posledny argument
  ...
  //HINT: znizit pocitadlo referencii povodnej stranky
  return 0;
}
